  ...
  return (
    <header className={styles.site_header}>
        ...
        <nav className={`${styles.flex} ${styles.nav}`}>
          ...
          <ul className={`${styles.nav_list} ${styles.list} ${styles.flex}`}>
            <li className={styles.nav_item}>
              <a
                href="/"
                className={`${styles.nav__link} ${styles.list} ${
            ...
            <li className={styles.nav_item}>
              <a
                href="/portfolio"
                className={`${styles.nav__link} ${styles.list} ${
                  isActive('/portfolio') ? styles.current : ''
                }`}>
                Портфоліо
              </a>
            </li>
            <li className={styles.nav_item}>
              <a
                href="/sertificate"
                className={`${styles.nav__link} ${styles.list} ${
                  isActive('/sertificate') ? styles.current : ''
                }`}>
                Сертифікат
              </a>
            </li>
        ...
        <ul className={`${styles.contacts} ${styles.list}`}>
          <li className={styles.contacts_item}>
            <a
              ...
              className={`${styles.contacts__link} ${styles.list}`}>
      ...
      <div
        ...
        <button
          className={`${styles.menu_toggle} ${styles.js_close_menu}`}
          onClick={toggleMenu}>
          <svg
            fill="currentColor"
            viewBox="0 0 20 20"
